...
**WARNING: As of 23 May, 2023, this feature only works for dynamic questions.**

For some **schoice** and **mchoice** questions, you may have more options to
choose from that you would want to appear on the test. For example, if the
...
how many options should be given on tests. For **schoice** questions, it is
guaranteed that one of the options is the correct answer.
