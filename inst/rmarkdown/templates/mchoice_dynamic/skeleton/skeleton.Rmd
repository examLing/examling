...
correct <- sample(qrow$correct[[1]], size = ncorrect)
incorrect <- sample(qrow$incorrect[[1]], size = nchoices - ncorrect)
...
extype: mchoice
exsolution: `r paste0(c(1, rep(0, nchoices - ncorrect)), collapse = "")`
